...
# ----- CONFIGURE THESE -----
SYNC_FOLDERS = ["Blueprints", "Boosterpacks", "BundledAssets", "Cards", "Icons", "Sounds"] # folders to be synced, such as Cards, Blueprints, Icons, etc.
COPY_FILES = ["manifest.json", "localization.tsv", "workfile.txt"] # individual files to copy, such as manifest.json, localization.tsv, etc. (the mod dll is copied automatically)
